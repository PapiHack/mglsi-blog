...
if(SessionManager::get('user')->getStatut() == 'admin')
    $entete = 'ESPACE ADMIN';
else if(SessionManager::get('user')->getStatut() == 'user')
...
<div id="contenu">
    <?php if($article != null) { ?>
        ...
        <p class="small pull-right"><strong> Par <?= $auteur ? $auteur->getPrenom().' '.$auteur->getNom() : 'Inconnue' ?> </strong></p>
    <?php } else { ?>
